...
class PackerApp:
    ...
    def __init__(self, master, language):
        ...
        self.tab_welcome_language_variable.trace_add("write", lambda *args: self.reload_with_language())
        ...
        self.panel_internal_supported_variable.trace_add("write", lambda *args: self.update_cabin_dropdowns())
        ...
        self.panel_internal_handling_variable.trace_add("write", lambda *args: self.update_cabin_dropdowns())
        ...
        self.panel_single_type_variable.trace_add("write", lambda *args: self.change_displayed_vehicle_dropdown())
        ...
        self.truck_search_variable.trace_add("write", lambda *args: self.update_vehicle_checkboxes())
        ...
        self.truck_mod_search_variable.trace_add("write", lambda *args: self.update_vehicle_checkboxes())
        ...
        self.bus_mod_search_variable.trace_add("write", lambda *args: self.update_vehicle_checkboxes())
        ...
        self.trailer_search_variable.trace_add("write", lambda *args: self.update_vehicle_checkboxes())
        ...
        self.trailer_mod_search_variable.trace_add("write", lambda *args: self.update_vehicle_checkboxes())
    ...
    def credits_screen(self, *args):
        ...
        credits.pjp_frame.columnconfigure(3, weight = 1)
        ...
        credits.pjp_title.grid(row = 0, column = 0, columnspan = 4, pady = (20, 0))
        ...
        credits.pjp_link.grid(row = 1, column = 0, columnspan = 4, pady = (5, 10))
        ...
        credits.pjp_licence.grid(row = 8, column = 0, columnspan = 4, padx = 20, pady = 15)
